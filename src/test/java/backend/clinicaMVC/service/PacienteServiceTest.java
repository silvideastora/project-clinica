...
import backend.clinicaMVC.dao.impl.PacienteDaoH2;
import backend.clinicaMVC.model.Domicilio;
...
public class PacienteServiceTest {
    ...
    static void crearTablas(){
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:h2:~/clinica0706;INIT=RUNSCRIPT FROM 'create.sql'", "sa", "sa");
        } catch (Exception e) {
            e.printStackTrace();
